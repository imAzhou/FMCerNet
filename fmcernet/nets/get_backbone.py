...
from .backbone.uni2h import UNI2H
from .backbone.virchow2 import Virchow2
...
from .backbone.LFreqViT.lfreqvit import LFreqViT
from .backbone.CytoFM_backbone import CytoFM
from .backbone.UniCAS_backbone import UniCAS

allowed_backbone_type = ['resnet', 'convnext', 'vit', 'smartccs', 'lfreqvit', 'cytofm', 'unicas', 'dinov2', 'dinov3', 'uni2-h', 'virchow2', 'gpfm', 'genbio-pathfm', 'ctranspath']
