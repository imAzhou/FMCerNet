...
class TransMIL(MIL):
    def __init__(self, in_dim: int, embed_dim: int,
                 ...
                 num_attention_layers: int, num_classes: int, classes, num_heads: int=8):
        """
        ...
        """
        super(TransMIL, self).__init__(in_dim=in_dim, embed_dim=embed_dim, num_classes=num_classes, classes=classes)
    ...
    def calc_loss(self, databatch):
        ...
        wsi_feats, log_dict = self.forward_features(input_x, return_attention=False)
