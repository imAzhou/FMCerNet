...
from fmcernet.nets.backbone.CTransPath.helper import trunc_normal_
from .mil_meta import MIL
from .layers import NystromAttention
...
class RRTMIL(MIL):
    ...
    def calc_loss(self, databatch):
        ...
        h, log_dict = self.forward_features(input_x)
        pred_logits = self.forward_head(h)
