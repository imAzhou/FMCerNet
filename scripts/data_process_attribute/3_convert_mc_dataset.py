...
def main():
    for mode in ['train', 'train_hs0', 'val']:
        anno_lines = []
        with open(f'data_resource/cell_attri/cell_inst/filter_{mode}_cellinst.json', 'r', encoding='utf-8') as f:
        ...
        with open(f'data_resource/cell_attri/cell_inst/filter_{mode}.txt', 'w') as f:
