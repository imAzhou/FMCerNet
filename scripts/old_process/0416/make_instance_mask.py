...
def make_instance_mask():
    ...
    mask_save_dir = '/c22073/zly/datasets/CervicalDatasets/LCerScanv4/instance_mask'
    ...
    for mode in ['train', 'val']:
        with open(f'/c22073/zly/datasets/CervicalDatasets/LCerScanv4/annofiles/{mode}_pure.json', 'r') as f:
