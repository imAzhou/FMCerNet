...
PATCH_EDGE = 700
cut_nums_each = 30
kfb_root_dir_1 = '/medical-data/data'
kfb_root_dir_2 = '/nfs-medical/vipa-medical/zheyi/zly'
img_save_dir = 'data_resource/0319/images/Neg'
os.makedirs(img_save_dir, exist_ok=True)
anno_save_dir = 'data_resource/0319/annofiles'
...
def cut_random_neg():
    ...
    train_csv = pd.read_csv('data_resource/slide_anno/0319/train.csv')
    val_csv = pd.read_csv('data_resource/slide_anno/0319/val.csv')
    filtered = {
    ...
    for mode in ['train','val']:
        ...
        for r_idx, row in filtered[mode].iterrows():
            ...
            kfb_root_dir = kfb_root_dir_1 if row['kfb_source'] != 'ZY_ONLINE_1' else kfb_root_dir_2
