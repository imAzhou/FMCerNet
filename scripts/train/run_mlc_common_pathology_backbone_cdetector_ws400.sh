...
if [[ "${CONDA_DEFAULT_ENV:-}" != "sam2" ]]; then
    echo "run_mlc_common_pathology_backbone_cdetector_ws400.sh must be run in the sam2 conda environment." >&2
    exit 1
fi

cd "$(dirname "$0")/../.."

DATASET_NAME="cdetector_ws400"
DATASET_BASE_CONFIG="../../../configs/dataset/cdetector_ws400.py"
...
run_train "query2label" "dinov2" "128" "224" "12700"
run_train "query2label" "virchow2" "64" "224" "12701"
run_train "query2label" "smartccs" "128" "224" "12702"
run_train "query2label" "fusionnet" "128" "1024" "12703"
run_train "ml_decoder" "dinov2" "128" "224" "12704"
run_train "ml_decoder" "virchow2" "64" "224" "12705"
run_train "ml_decoder" "smartccs" "128" "224" "12706"
run_train "ml_decoder" "fusionnet" "128" "1024" "12707"
run_train "mlc_nc" "dinov2" "128" "224" "12708"
run_train "mlc_nc" "virchow2" "64" "224" "12709"
run_train "mlc_nc" "smartccs" "128" "224" "12710"
run_train "mlc_nc" "fusionnet" "128" "1024" "12711"
run_train "wscer_mlc" "dinov2" "128" "224" "12712"
run_train "wscer_mlc" "virchow2" "64" "224" "12713"
run_train "wscer_mlc" "smartccs" "128" "224" "12714"
run_train "wscer_mlc" "fusionnet" "128" "1024" "12715"
