...
WINDOW_SIZE = 850
targetjson = f'data_resource/WINDOW_SIZE_{WINDOW_SIZE}/hardsample_annofiles/multilable_hs_round2.json'
target_imgdir = f'data_resource/WINDOW_SIZE_{WINDOW_SIZE}/images'
pos_srcjson = f'scripts/copy_past/hicervix_WS{WINDOW_SIZE}.json'
random_cnt = [1,2]
paste_type = 'otsu'  # poisson,otsu
prefix = f'paste_hicervix_{paste_type}'
pastimg_savedir = f'data_resource/WINDOW_SIZE_{WINDOW_SIZE}/images/{prefix}'
pasted_savejson = f'data_resource/WINDOW_SIZE_{WINDOW_SIZE}/hardsample_annofiles/hs_round2_hicervix_{paste_type}.json'
...
def main():
    ...
    print(f'Pasted {len(pastelist)} image samples.')
