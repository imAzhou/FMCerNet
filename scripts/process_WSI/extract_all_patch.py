...
LEVEL,PATCH_EDGE = 0,800
CERTAIN_THR,POSITIVE_THR = 0.7,0.5
SEED,SAFE_MARGIN = 1234,100
test_bs = 64
valid_ckpt = 'checkpoints/valid_cls_best.pth'
WSI_feat_savedir = f'data_resource/LCerScan/WS{PATCH_EDGE}/slide_feat_ours'
os.makedirs(WSI_feat_savedir, exist_ok=True, mode=0o777)
infer_csv_files = [
    'data_resource/LCerScan/train.csv',
    'data_resource/LCerScan/val.csv',
]

pnmodel_rootdir = 'work_dir/mlc/ours/ws800'
mmcls_config_file = f'{pnmodel_rootdir}/config.py'
mmcls_ckpt = f'{pnmodel_rootdir}/checkpoints/best.pth'
infer_log_savepath = f'{pnmodel_rootdir}/wsi_infer.log'
infer_txt_savepath = f'{pnmodel_rootdir}/wsi_infer_result.txt'

tmp_dir = f'{pnmodel_rootdir}/tmp'
tmp_logtxt_dir = f'{tmp_dir}/extract_WSI_feats'
