...
def merge_multilevel_testdemo():
    ...
    for purename in purenames:
        ...
        visual_merged_masks(img, merged_mask, save_path=f'{mask_savedir}/merged_result_bboxes_iou0.6.png', size_thresh=50)
...
def merge_multilevel():
    for tag in ['fold1_train', 'fold1_val']:
        ...
        #     pred_instances = dict(
        #         bboxes=torch.as_tensor(pred_bboxes),
...
if __name__ == "__main__":
    ...
    # infer_multilevel(4000,-1,torch.device("cuda:2"))
